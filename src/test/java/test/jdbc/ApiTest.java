...
public class ApiTest {
    ...
    public void executeInsert() {
        jdbcTemplate.execute("insert into user(username) values('苍镜月')");
        jdbcTemplate.execute("insert into user(username) values('LunaY')");
    }

    @Test
    public void executeUpdate() {
        jdbcTemplate.execute("update user set username = 'update' where id = 1");
    }
